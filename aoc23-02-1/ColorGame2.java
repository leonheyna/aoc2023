...
public class ColorGame2 {
    public static void main(String[] args) {
        ...
        while (fileScanner.hasNext()) {
            ...
            int highestRedInGame = 0;
            int highestGreenInGame = 0;
            int highestBlueInGame = 0;
            ...
            for (String round : rounds) {
                ...
                for (String color : colors) {
                    ...
                    switch (cubesColor) {
                        case "red":
                            if (cubesNumber > highestRedInGame) {
                                highestRedInGame = cubesNumber;
                            }
                            if (cubesNumber > red) {
                                possible = false;
                            }
                            break;
                        case "green":
                            if (cubesNumber > highestGreenInGame) {
                                highestGreenInGame = cubesNumber;
                            }
                            ...
                            break;
                        case "blue":
                            if (cubesNumber > highestBlueInGame) {
                                highestBlueInGame = cubesNumber;
                            }
                            if (cubesNumber > blue) {
                                possible = false;
                            }
            ...
            System.out.printf("\n min red: %d, min green: %d, min blue: %d",
                    highestRedInGame, highestGreenInGame, highestBlueInGame);
            int power = highestRedInGame * highestGreenInGame * highestBlueInGame;
            System.out.printf("\n game #%d has power: %d", gameNumber, power);
            powerSum += power;
        ...
        System.out.printf("\n sum of gamenumbers is %d \n", sum);
        System.out.printf("\n powersum of games is %d \n", powerSum);
    }
}
